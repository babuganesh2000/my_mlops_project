...
dbutils.widgets.text(
    "model_name", "dev.mlops_journey.my_mlops_project-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.mlops_journey.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.mlops_journey.trip_dropoff_features",
